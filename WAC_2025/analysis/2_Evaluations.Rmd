...
data <- broom.mixed::augment(model, data = data) # add residuals to data file paired with the correct rows
...
data <- broom.mixed::augment(model2, data = data) # add residuals to data file paired with the correct rows
