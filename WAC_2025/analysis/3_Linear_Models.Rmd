...
model8 <- lmer(First_Summer_ALF_Biomass_sqrt ~ selected_type*LOC + (1|LOC:Rep), data=data)
...
```{r}
model14 <- clmm(Alfalfa_Regrowth ~ selected_type * LOC + (1|LOC:Rep) + (1|Entry), data = data)
summary(model14)
